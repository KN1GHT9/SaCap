...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        # change src code if not has attr crossattention pass ,else cross_attention
        if encoder_hidden_states is not None:
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        # add prefix in inputs_embeds
        if prefix != None:
            prefix = prefix.expand(inputs_embeds.shape[0], prefix.shape[1], inputs_embeds.shape[2])
            inputs_embeds = torch.cat((prefix, inputs_embeds[:, prefix.shape[1]:, :]), dim = 1)
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            ################################################## ,label_smoothing=0.1
            loss_fct = CrossEntropyLoss(ignore_index = 50256, reduction = reduction)
