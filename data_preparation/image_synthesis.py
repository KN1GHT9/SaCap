...
def generate_syn_img(args):
    device = args.device
    image_root = f"../data/{args.dataset}/train/synthetic_images"
    ...
    with open(f"../data/{args.dataset}/train/synthetic_image_pk_dict.json") as f:
        data = json.load(f)
...
def extract_syn_img_feature(args):
    ...
    torch.save(res_dict,f"../data/{args.dataset}/train/synthetic_image_global_feature_dict.pt")
